...
import app.entities.Artist; // HUSK DENNE IMPORT
...
public class HibernateConfig {
    ...
    // HER REGISTRERER VI ARTIST KLASSEN
    ...
    private static Properties setBaseProperties(Properties props) {
        ...
        props.put("hibernate.hbm2ddl.auto", "create"); // 'update' er sikrere end 'create' til dev
        props.put("hibernate.current_session_context_class", "thread");
        props.put("hibernate.show_sql", "true"); // Sat til true så vi kan se hvad der sker
